...
try {
		Debug.PushSubsStack("asView (typejudge) ","typejudge",2,__ref.getField(false, "ba"),__ref,42);
...
try {
		Debug.PushSubsStack("AVtypeBtn_Click (typejudge) ","typejudge",2,__ref.getField(false, "ba"),__ref,46);
...
try {
		Debug.PushSubsStack("EXEtypeBtn_Click (typejudge) ","typejudge",2,__ref.getField(false, "ba"),__ref,54);
...
try {
		Debug.PushSubsStack("Initialize (typejudge) ","typejudge",2,__ref.getField(false, "ba"),__ref,12);
...
__ref.getField(false,"_btnav").runMethod(true,"setText",BA.ObjectToCharSequence(typejudge._main._translate.runClassMethod (b4a.example.translator.class, "_getstring",(Object)(RemoteObject.createImmutable("AVbtn")))));
...
__ref.getField(false,"_btntv").runMethod(true,"setText",BA.ObjectToCharSequence(typejudge._main._translate.runClassMethod (b4a.example.translator.class, "_getstring",(Object)(RemoteObject.createImmutable("TVbtn")))));
...
Debug.ShouldStop(16);
__ref.getField(false,"_btnexe").runMethod(true,"setText",BA.ObjectToCharSequence(typejudge._main._translate.runClassMethod (b4a.example.translator.class, "_getstring",(Object)(RemoteObject.createImmutable("EXEbtn")))));
...
try {
		Debug.PushSubsStack("TVtypeBtn_Click (typejudge) ","typejudge",2,__ref.getField(false, "ba"),__ref,50);
