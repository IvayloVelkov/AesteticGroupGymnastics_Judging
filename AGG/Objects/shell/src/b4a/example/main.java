...
public static b4a.example.helperfunctions _helperfunctions = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",main.mostCurrent._activity,"HelperFunctions",Debug.moduleToString(b4a.example.helperfunctions.class),"intFontTransfer",main._intfonttransfer,"Login",main.mostCurrent._login,"ProgramData",Debug.moduleToString(b4a.example.programdata.class),"SelectedLanguage",main._selectedlanguage,"Starter",Debug.moduleToString(b4a.example.starter.class),"translate",main._translate,"typeJ",main.mostCurrent._typej,"UISizes",Debug.moduleToString(b4a.example.uisizes.class),"Version",Debug.moduleToString(b4a.example.version.class)};
}
}