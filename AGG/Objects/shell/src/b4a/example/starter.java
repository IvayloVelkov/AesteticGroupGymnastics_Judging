...
public static b4a.example.helperfunctions _helperfunctions = null;
  public Object[] GetGlobals() {
		return new Object[] {"HelperFunctions",Debug.moduleToString(b4a.example.helperfunctions.class),"Main",Debug.moduleToString(b4a.example.main.class),"ProgramData",Debug.moduleToString(b4a.example.programdata.class),"Service",starter.mostCurrent._service,"UISizes",Debug.moduleToString(b4a.example.uisizes.class),"Version",Debug.moduleToString(b4a.example.version.class)};
}
}