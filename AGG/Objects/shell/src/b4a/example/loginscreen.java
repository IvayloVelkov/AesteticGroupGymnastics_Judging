...
public static RemoteObject _usericon = RemoteObject.declareNull("anywheresoftware.b4a.objects.ImageViewWrapper");
public static RemoteObject _passicon = RemoteObject.declareNull("anywheresoftware.b4a.objects.ImageViewWrapper");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"btnExit",_ref.getField(false, "_btnexit"),"btnloginPanel",_ref.getField(false, "_btnloginpanel"),"btnloginPanelTimer",_ref.getField(false, "_btnloginpaneltimer"),"btnSettings",_ref.getField(false, "_btnsettings"),"CAD",_ref.getField(false, "_cad"),"checkloginPanel",_ref.getField(false, "_checkloginpanel"),"loginPanel",_ref.getField(false, "_loginpanel"),"pass",_ref.getField(false, "_pass"),"passIcon",_ref.getField(false, "_passicon"),"passString",_ref.getField(false, "_passstring"),"raf",_ref.getField(false, "_raf"),"user",_ref.getField(false, "_user"),"userIcon",_ref.getField(false, "_usericon"),"usrString",_ref.getField(false, "_usrstring")};
}
}