...
public static b4a.example.starter _starter = null;
  public Object[] GetGlobals() {
		return new Object[] {"Main",Debug.moduleToString(b4a.example.main.class),"ProgramData",Debug.moduleToString(b4a.example.programdata.class),"Starter",Debug.moduleToString(b4a.example.starter.class),"UISizes",Debug.moduleToString(b4a.example.uisizes.class),"Version",Debug.moduleToString(b4a.example.version.class)};
}
}