...
public static RemoteObject  _finaavscore(RemoteObject __ref) throws Exception{
try {
		Debug.PushSubsStack("finaAVscore (av_judge) ","av_judge",2,__ref.getField(false, "ba"),__ref,147);
if (RapidSub.canDelegate("finaavscore")) return __ref.runUserSub(false, "av_judge","finaavscore", __ref);
 BA.debugLineNum = 147;BA.debugLine="Public Sub finaAVscore As Double";
Debug.ShouldStop(262144);
...
av_judge.__c.runMethodAndSync(false,"CallSubNew",__ref.getField(false, "ba"),(Object)((av_judge._main.getObject())),(Object)(RemoteObject.createImmutable("FinalClick")));
 BA.debugLineNum = 154;BA.debugLine="finaAVscore";
Debug.ShouldStop(33554432);
__ref.runClassMethod (agg.agg.av_judge.class, "_finaavscore");
