...
translator._workingproduct = RemoteObject.createNew ("agg.agg.translator._product");__ref.setField("_workingproduct",translator._workingproduct);
...
try {
		Debug.PushSubsStack("Duplicate_Map (translator) ","translator",8,__ref.getField(false, "ba"),__ref,158);
...
try {
		Debug.PushSubsStack("Generate_LanguageList (translator) ","translator",8,__ref.getField(false, "ba"),__ref,169);
...
try {
		Debug.PushSubsStack("Generate_MapRow (translator) ","translator",8,__ref.getField(false, "ba"),__ref,183);
...
Debug.ShouldStop(1073741824);
__ref.runClassMethod (agg.agg.translator.class, "_update_existinglanguage",(Object)(_name),(Object)(_keytranslation));
 }else {
 BA.debugLineNum = 193;BA.debugLine="Import_NewLanguage(Name, newRecords)";
Debug.ShouldStop(1);
__ref.runClassMethod (agg.agg.translator.class, "_import_newlanguage",(Object)(_name),(Object)(_newrecords));
 };
...
try {
		Debug.PushSubsStack("Get_Language (translator) ","translator",8,__ref.getField(false, "ba"),__ref,253);
...
try {
		Debug.PushSubsStack("Get_LanguageList (translator) ","translator",8,__ref.getField(false, "ba"),__ref,231);
...
try {
		Debug.PushSubsStack("Get_TranslatedString (translator) ","translator",8,__ref.getField(false, "ba"),__ref,285);
...
try {
		Debug.PushSubsStack("Get_Translation (translator) ","translator",8,__ref.getField(false, "ba"),__ref,268);
...
Debug.ShouldStop(8192);
_translationstring = __ref.runClassMethod (agg.agg.translator.class, "_get_translatedstring",(Object)(_key),(Object)(__ref.getField(false,"_workingproduct").getField(true,"selectedLanguage")));Debug.locals.put("translationString", _translationstring);Debug.locals.put("translationString", _translationstring);
...
Debug.ShouldStop(131072);
Debug.CheckDeviceExceptions();if (true) return __ref.runClassMethod (agg.agg.translator.class, "_get_translatedstring",(Object)(_key),(Object)(__ref.getField(true,"_en")));
 };
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e9) {
...
try {
		Debug.PushSubsStack("GetString (translator) ","translator",8,__ref.getField(false, "ba"),__ref,259);
...
Debug.ShouldStop(16);
if (true) return __ref.runClassMethod (agg.agg.translator.class, "_get_translation",(Object)(_key));
 }else {
 BA.debugLineNum = 263;BA.debugLine="Return Get_Translation(\"strStringNotFound\")";
Debug.ShouldStop(64);
if (true) return __ref.runClassMethod (agg.agg.translator.class, "_get_translation",(Object)(RemoteObject.createImmutable("strStringNotFound")));
 };
...
try {
		Debug.PushSubsStack("Import_NewLanguage (translator) ","translator",8,__ref.getField(false, "ba"),__ref,208);
...
try {
		Debug.PushSubsStack("Initialize (translator) ","translator",8,__ref.getField(false, "ba"),__ref,27);
...
Debug.ShouldStop(4);
__ref.runClassMethod (agg.agg.translator.class, "_open_xml",(Object)(__ref.getField(true,"_filedirpath")),(Object)(RemoteObject.concat(translator._version.runMethod(true,"_path",__ref.runMethod(false,"getActivityBA")),RemoteObject.createImmutable("/dictionary.xml"))));
 }else {
 BA.debugLineNum = 37;BA.debugLine="Open_XML(File.DirAssets, \"dictionary.xml\")";
Debug.ShouldStop(16);
__ref.runClassMethod (agg.agg.translator.class, "_open_xml",(Object)(translator.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("dictionary.xml")));
 };
 };
 Debug.CheckDeviceExceptions();
} 
...
try {
		Debug.PushSubsStack("Open_XML (translator) ","translator",8,__ref.getField(false, "ba"),__ref,51);
...
Debug.ShouldStop(524288);
__ref.runClassMethod (agg.agg.translator.class, "_resetvariables");
...
Debug.ShouldStop(4194304);
__ref.runClassMethod (agg.agg.translator.class, "_parse_xml",(Object)(_filepath),(Object)(_filename));
 BA.debugLineNum = 56;BA.debugLine="SetProduct(selectedProduct)";
Debug.ShouldStop(8388608);
__ref.runClassMethod (agg.agg.translator.class, "_setproduct",(Object)(__ref.getField(true,"_selectedproduct")));
...
try {
		Debug.PushSubsStack("Parse_XML (translator) ","translator",8,__ref.getField(false, "ba"),__ref,65);
...
try {
		Debug.PushSubsStack("ResetVariables (translator) ","translator",8,__ref.getField(false, "ba"),__ref,93);
...
try {
		Debug.PushSubsStack("SetLanguage (translator) ","translator",8,__ref.getField(false, "ba"),__ref,247);
...
try {
		Debug.PushSubsStack("SetProduct (translator) ","translator",8,__ref.getField(false, "ba"),__ref,236);
...
Debug.ShouldStop(32768);
__ref.setField ("_dictionary",__ref.runClassMethod (agg.agg.translator.class, "_duplicate_map",(Object)(__ref.getField(false,"_workingproduct").getField(false,"dictionary"))));
...
try {
		Debug.PushSubsStack("Update_ExistingLanguage (translator) ","translator",8,__ref.getField(false, "ba"),__ref,220);
...
try {
		Debug.PushSubsStack("xmlParser_EndElement (translator) ","translator",8,__ref.getField(false, "ba"),__ref,104);
...
Debug.ShouldStop(4096);
_currentproduct = RemoteObject.createNew ("agg.agg.translator._product");Debug.locals.put("currentProduct", _currentproduct);
...
Debug.ShouldStop(32768);
_currentproduct.setField ("languageMap",__ref.runClassMethod (agg.agg.translator.class, "_duplicate_map",(Object)(__ref.getField(false,"_workingproduct").getField(false,"languageMap"))));
...
Debug.ShouldStop(131072);
_currentproduct.setField ("languagesDisplayNames",__ref.runClassMethod (agg.agg.translator.class, "_duplicate_map",(Object)(__ref.getField(false,"_workingproduct").getField(false,"languagesDisplayNames"))));
...
Debug.ShouldStop(524288);
_currentproduct.setField ("dictionary",__ref.runClassMethod (agg.agg.translator.class, "_duplicate_map",(Object)(__ref.getField(false,"_dictionary"))));
...
Debug.ShouldStop(2097152);
_currentproduct.setField ("languagesBeforeUpdate",__ref.runClassMethod (agg.agg.translator.class, "_duplicate_map",(Object)(__ref.getField(false,"_workingproduct").getField(false,"languagesBeforeUpdate"))));
...
Debug.ShouldStop(4);
__ref.runClassMethod (agg.agg.translator.class, "_generate_languagelist",(Object)(BA.ObjectToString(_text)));
 };
...
Debug.ShouldStop(8388608);
__ref.runClassMethod (agg.agg.translator.class, "_generate_maprow",(Object)(_name),(Object)(_text),(Object)(__ref.getField(true,"_langabbreviature")));
 };
 };
...
try {
		Debug.PushSubsStack("xmlParser_StartElement (translator) ","translator",8,__ref.getField(false, "ba"),__ref,74);
