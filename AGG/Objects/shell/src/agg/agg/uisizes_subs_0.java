...
try {
		Debug.PushSubsStack("Initialize (uisizes) ","uisizes",10,_ba,uisizes.mostCurrent,10);
if (RapidSub.canDelegate("initialize")) return agg.agg.uisizes.remoteMe.runUserSub(false, "uisizes","initialize", _ba);
;
