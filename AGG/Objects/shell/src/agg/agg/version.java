...
public boolean isSingleton() {
    ...
    static {
        ...
        remoteMe = RemoteObject.declareNull("agg.agg.version");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("version"), "agg.agg.version");
        RDebug.INSTANCE.eventTargets.put(new DeviceClass("agg.agg.version"), new java.lang.ref.WeakReference<PCBA> (pcBA));
	}
...
public static agg.agg.helperfunctions _helperfunctions = null;
  public Object[] GetGlobals() {
		return new Object[] {"HelperFunctions",Debug.moduleToString(agg.agg.helperfunctions.class),"Main",Debug.moduleToString(agg.agg.main.class),"ProductID",version._productid,"ProductInDictionary",version._productindictionary,"ProgramData",Debug.moduleToString(agg.agg.programdata.class),"ProgramName",version._programname,"Starter",Debug.moduleToString(agg.agg.starter.class),"UISizes",Debug.moduleToString(agg.agg.uisizes.class)};
}
}