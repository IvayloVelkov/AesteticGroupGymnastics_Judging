...
public class helperfunctions_subs_0 {
...
try {
		Debug.PushSubsStack("Apply_ViewStyle (helperfunctions) ","helperfunctions",12,_ba,helperfunctions.mostCurrent,9);
if (RapidSub.canDelegate("apply_viewstyle")) return agg.agg.helperfunctions.remoteMe.runUserSub(false, "helperfunctions","apply_viewstyle", _ba, _control, _textcolor, _colora, _colorb, _colorpresseda, _colorpressedb, _colordisableda, _colordisabledb, _cornerround);
...
Debug.locals.put("CornerRound", _cornerround);
 BA.debugLineNum = 9;BA.debugLine="Public Sub Apply_ViewStyle (Control As View, TextC";
Debug.ShouldStop(256);
 BA.debugLineNum = 10;BA.debugLine="If Control Is Button Then			'Handle controls with";
Debug.ShouldStop(512);
if (RemoteObject.solveBoolean("i",_control.getObjectOrNull(), RemoteObject.createImmutable("android.widget.Button"))) { 
 BA.debugLineNum = 11;BA.debugLine="Private btn As Button = Control";
...
_btn.setObject(_control.getObject());Debug.locals.put("btn", _btn);
 BA.debugLineNum = 12;BA.debugLine="btn.TextColor = TextColor";
Debug.ShouldStop(2048);
_btn.runMethod(true,"setTextColor",_textcolor);
 };
 BA.debugLineNum = 14;BA.debugLine="If Control Is EditText Then";
Debug.ShouldStop(8192);
if (RemoteObject.solveBoolean("i",_control.getObjectOrNull(), RemoteObject.createImmutable("android.widget.EditText"))) { 
 BA.debugLineNum = 15;BA.debugLine="Private txt As EditText = Control";
...
_txt.setObject(_control.getObject());Debug.locals.put("txt", _txt);
 BA.debugLineNum = 16;BA.debugLine="txt.TextColor = TextColor";
Debug.ShouldStop(32768);
_txt.runMethod(true,"setTextColor",_textcolor);
 };
 BA.debugLineNum = 18;BA.debugLine="If Control Is Spinner Then";
...
if (RemoteObject.solveBoolean("i",_control.getObjectOrNull(), RemoteObject.createImmutable("anywheresoftware.b4a.objects.SpinnerWrapper.B4ASpinner"))) { 
 BA.debugLineNum = 19;BA.debugLine="Private sp As Spinner = Control";
...
_sp.setObject(_control.getObject());Debug.locals.put("sp", _sp);
 BA.debugLineNum = 20;BA.debugLine="sp.TextColor = TextColor";
Debug.ShouldStop(524288);
_sp.runMethod(true,"setTextColor",_textcolor);
 };
 BA.debugLineNum = 23;BA.debugLine="Control.Background = Helper_Gradient(ColorA, Colo";
...
_control.runMethod(false,"setBackground",(_helper_gradient(_ba,_colora,_colorb,_colorpresseda,_colorpressedb,_colordisableda,_colordisabledb,_cornerround).getObject()));
 BA.debugLineNum = 24;BA.debugLine="Remove_Padding(Control)";
...
try {
		Debug.PushSubsStack("Helper_Gradient (helperfunctions) ","helperfunctions",12,_ba,helperfunctions.mostCurrent,26);
if (RapidSub.canDelegate("helper_gradient")) return agg.agg.helperfunctions.remoteMe.runUserSub(false, "helperfunctions","helper_gradient", _ba, _colora, _colorb, _colorpresseda, _colorpressedb, _colordisableda, _colordisabledb, _cornerround);
...
Debug.locals.put("ColorDisabledB", _colordisabledb);
Debug.locals.put("CornerRound", _cornerround);
 BA.debugLineNum = 26;BA.debugLine="Private Sub Helper_Gradient(ColorA As Int, ColorB";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 27;BA.debugLine="Private colsEnabled(2) As Int				'Дефинира два цв";
Debug.ShouldStop(67108864);
_colsenabled = RemoteObject.createNewArray ("int", new int[] {2}, new Object[]{});Debug.locals.put("colsEnabled", _colsenabled);
 BA.debugLineNum = 28;BA.debugLine="colsEnabled(0) = ColorA";
Debug.ShouldStop(134217728);
_colsenabled.setArrayElement (_colora,BA.numberCast(int.class, 0));
 BA.debugLineNum = 29;BA.debugLine="colsEnabled(1) = ColorB";
Debug.ShouldStop(268435456);
_colsenabled.setArrayElement (_colorb,BA.numberCast(int.class, 1));
 BA.debugLineNum = 30;BA.debugLine="Private gdwEnabled As GradientDrawable		'Дефинира";
...
_gdwenabled = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.GradientDrawable");Debug.locals.put("gdwEnabled", _gdwenabled);
 BA.debugLineNum = 31;BA.debugLine="gdwEnabled.Initialize(\"TOP_BOTTOM\", colsEnabled)";
...
_gdwenabled.runVoidMethod ("Initialize",(Object)(BA.getEnumFromString(BA.getDeviceClass("android.graphics.drawable.GradientDrawable.Orientation"),"TOP_BOTTOM")),(Object)(_colsenabled));
 BA.debugLineNum = 32;BA.debugLine="gdwEnabled.CornerRadius = CornerRound";
Debug.ShouldStop(-2147483648);
_gdwenabled.runVoidMethod ("setCornerRadius",BA.numberCast(float.class, _cornerround));
 BA.debugLineNum = 33;BA.debugLine="Private colsPressed(2) As Int				'Дефинира два цв";
Debug.ShouldStop(1);
_colspressed = RemoteObject.createNewArray ("int", new int[] {2}, new Object[]{});Debug.locals.put("colsPressed", _colspressed);
 BA.debugLineNum = 34;BA.debugLine="colsPressed(0) = ColorPressedA";
Debug.ShouldStop(2);
_colspressed.setArrayElement (_colorpresseda,BA.numberCast(int.class, 0));
 BA.debugLineNum = 35;BA.debugLine="colsPressed(1) = ColorPressedB";
Debug.ShouldStop(4);
_colspressed.setArrayElement (_colorpressedb,BA.numberCast(int.class, 1));
 BA.debugLineNum = 36;BA.debugLine="Private gdwPressed As GradientDrawable		'Дефинира";
Debug.ShouldStop(8);
_gdwpressed = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.GradientDrawable");Debug.locals.put("gdwPressed", _gdwpressed);
 BA.debugLineNum = 37;BA.debugLine="gdwPressed.Initialize(\"TOP_BOTTOM\", colsPressed)";
Debug.ShouldStop(16);
_gdwpressed.runVoidMethod ("Initialize",(Object)(BA.getEnumFromString(BA.getDeviceClass("android.graphics.drawable.GradientDrawable.Orientation"),"TOP_BOTTOM")),(Object)(_colspressed));
 BA.debugLineNum = 38;BA.debugLine="gdwPressed.CornerRadius = CornerRound";
Debug.ShouldStop(32);
_gdwpressed.runVoidMethod ("setCornerRadius",BA.numberCast(float.class, _cornerround));
 BA.debugLineNum = 39;BA.debugLine="Private colsDisabled(2) As Int				'Дефинира два ц";
Debug.ShouldStop(64);
_colsdisabled = RemoteObject.createNewArray ("int", new int[] {2}, new Object[]{});Debug.locals.put("colsDisabled", _colsdisabled);
 BA.debugLineNum = 40;BA.debugLine="colsDisabled(0) = ColorDisabledA";
Debug.ShouldStop(128);
_colsdisabled.setArrayElement (_colordisableda,BA.numberCast(int.class, 0));
 BA.debugLineNum = 41;BA.debugLine="colsDisabled(1) = ColorDisabledB";
Debug.ShouldStop(256);
_colsdisabled.setArrayElement (_colordisabledb,BA.numberCast(int.class, 1));
 BA.debugLineNum = 42;BA.debugLine="Private gdwDisabled As GradientDrawable		'Дефинир";
Debug.ShouldStop(512);
_gdwdisabled = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.GradientDrawable");Debug.locals.put("gdwDisabled", _gdwdisabled);
 BA.debugLineNum = 43;BA.debugLine="gdwDisabled.Initialize(\"TOP_BOTTOM\", colsDisabled";
Debug.ShouldStop(1024);
_gdwdisabled.runVoidMethod ("Initialize",(Object)(BA.getEnumFromString(BA.getDeviceClass("android.graphics.drawable.GradientDrawable.Orientation"),"TOP_BOTTOM")),(Object)(_colsdisabled));
 BA.debugLineNum = 44;BA.debugLine="gdwDisabled.CornerRadius = CornerRound";
Debug.ShouldStop(2048);
_gdwdisabled.runVoidMethod ("setCornerRadius",BA.numberCast(float.class, _cornerround));
 BA.debugLineNum = 45;BA.debugLine="Private stdGradient As StateListDrawable	'Дефинир";
...
_stdgradient = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.StateListDrawable");Debug.locals.put("stdGradient", _stdgradient);
 BA.debugLineNum = 46;BA.debugLine="stdGradient.Initialize";
Debug.ShouldStop(8192);
_stdgradient.runVoidMethod ("Initialize");
 BA.debugLineNum = 47;BA.debugLine="Private states(2) As Int";
Debug.ShouldStop(16384);
_states = RemoteObject.createNewArray ("int", new int[] {2}, new Object[]{});Debug.locals.put("states", _states);
 BA.debugLineNum = 48;BA.debugLine="states(0) = stdGradient.State_Enabled";
Debug.ShouldStop(32768);
_states.setArrayElement (_stdgradient.getField(true,"State_Enabled"),BA.numberCast(int.class, 0));
 BA.debugLineNum = 49;BA.debugLine="states(1) = -stdGradient.State_Pressed";
...
_states.setArrayElement (BA.numberCast(int.class, -(double) (0 + _stdgradient.getField(true,"State_Pressed").<Integer>get().intValue())),BA.numberCast(int.class, 1));
 BA.debugLineNum = 50;BA.debugLine="stdGradient.addState2(states, gdwEnabled)";
Debug.ShouldStop(131072);
_stdgradient.runVoidMethod ("AddState2",(Object)(_states),(Object)((_gdwenabled.getObject())));
 BA.debugLineNum = 51;BA.debugLine="Private states(1) As Int";
Debug.ShouldStop(262144);
_states = RemoteObject.createNewArray ("int", new int[] {1}, new Object[]{});Debug.locals.put("states", _states);
 BA.debugLineNum = 52;BA.debugLine="states(0) = stdGradient.State_Pressed";
Debug.ShouldStop(524288);
_states.setArrayElement (_stdgradient.getField(true,"State_Pressed"),BA.numberCast(int.class, 0));
 BA.debugLineNum = 53;BA.debugLine="stdGradient.addState2(states, gdwPressed)";
Debug.ShouldStop(1048576);
_stdgradient.runVoidMethod ("AddState2",(Object)(_states),(Object)((_gdwpressed.getObject())));
 BA.debugLineNum = 54;BA.debugLine="Private states(1) As Int";
Debug.ShouldStop(2097152);
_states = RemoteObject.createNewArray ("int", new int[] {1}, new Object[]{});Debug.locals.put("states", _states);
 BA.debugLineNum = 55;BA.debugLine="states(0) = stdGradient.State_Disabled";
Debug.ShouldStop(4194304);
_states.setArrayElement (_stdgradient.getField(true,"State_Disabled"),BA.numberCast(int.class, 0));
 BA.debugLineNum = 56;BA.debugLine="stdGradient.addState2(states, gdwDisabled)";
Debug.ShouldStop(8388608);
_stdgradient.runVoidMethod ("AddState2",(Object)(_states),(Object)((_gdwdisabled.getObject())));
 BA.debugLineNum = 57;BA.debugLine="Return stdGradient							'Връща градиента като па";
Debug.ShouldStop(16777216);
...
helperfunctions._tvscore1 = BA.ObjectToString("0.10");
 //BA.debugLineNum = 3;BA.debugLine="Public TvScore2 As String = \"0.20\"";
helperfunctions._tvscore2 = BA.ObjectToString("0.20");
 //BA.debugLineNum = 4;BA.debugLine="Public TvScore3 As String = \"0.30\"";
helperfunctions._tvscore3 = BA.ObjectToString("0.30");
 //BA.debugLineNum = 5;BA.debugLine="Public TvScore4 As String = \"0.40\"";
helperfunctions._tvscore4 = BA.ObjectToString("0.40");
 //BA.debugLineNum = 6;BA.debugLine="Public TvScore5 As String = \"0.50\"";
helperfunctions._tvscore5 = BA.ObjectToString("0.50");
 //BA.debugLineNum = 7;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _remove_padding(RemoteObject _ba,RemoteObject _obj) throws Exception{
try {
		Debug.PushSubsStack("Remove_Padding (helperfunctions) ","helperfunctions",12,_ba,helperfunctions.mostCurrent,60);
if (RapidSub.canDelegate("remove_padding")) return agg.agg.helperfunctions.remoteMe.runUserSub(false, "helperfunctions","remove_padding", _ba, _obj);
...
Debug.locals.put("obj", _obj);
 BA.debugLineNum = 60;BA.debugLine="Public Sub Remove_Padding (obj As Object)		'Премах";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 61;BA.debugLine="Private pad = 0dip As Int";
Debug.ShouldStop(268435456);
_pad = helperfunctions.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("pad", _pad);Debug.locals.put("pad", _pad);
 BA.debugLineNum = 62;BA.debugLine="Private reflect As Reflector";
Debug.ShouldStop(536870912);
_reflect = RemoteObject.createNew ("anywheresoftware.b4a.agraham.reflection.Reflection");Debug.locals.put("reflect", _reflect);
 BA.debugLineNum = 63;BA.debugLine="reflect.Target = obj";
Debug.ShouldStop(1073741824);
_reflect.setField ("Target",_obj);
 BA.debugLineNum = 64;BA.debugLine="reflect.RunMethod4(\"setPadding\", Array As Object(";
Debug.ShouldStop(-2147483648);
