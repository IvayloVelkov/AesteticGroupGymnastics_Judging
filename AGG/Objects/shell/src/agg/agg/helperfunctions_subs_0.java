...
try {
		Debug.PushSubsStack("Apply_ViewStyle (helperfunctions) ","helperfunctions",12,_ba,helperfunctions.mostCurrent,5);
...
try {
		Debug.PushSubsStack("Helper_Gradient (helperfunctions) ","helperfunctions",12,_ba,helperfunctions.mostCurrent,22);
...
try {
		Debug.PushSubsStack("Remove_Padding (helperfunctions) ","helperfunctions",12,_ba,helperfunctions.mostCurrent,56);
...
_reflect.setField ("Target",_obj);
 BA.debugLineNum = 60;BA.debugLine="reflect.RunMethod4(\"setPadding\", Array As Object(";
Debug.ShouldStop(134217728);
