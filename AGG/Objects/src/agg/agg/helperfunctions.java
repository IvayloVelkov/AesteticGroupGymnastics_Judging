...
public static String _tvresult = "";
public static String _avresult = "";
public static String _exeresult = "";
...
anywheresoftware.b4a.objects.SpinnerWrapper _sp = null;
 //BA.debugLineNum = 13;BA.debugLine="Public Sub Apply_ViewStyle (Control As View, TextC";
 //BA.debugLineNum = 14;BA.debugLine="If Control Is Button Then			'Handle controls with";
if (_control.getObjectOrNull() instanceof android.widget.Button) { 
 //BA.debugLineNum = 15;BA.debugLine="Private btn As Button = Control";
_btn = new anywheresoftware.b4a.objects.ButtonWrapper();
_btn.setObject((android.widget.Button)(_control.getObject()));
 //BA.debugLineNum = 16;BA.debugLine="btn.TextColor = TextColor";
...
if (_control.getObjectOrNull() instanceof android.widget.EditText) { 
 //BA.debugLineNum = 19;BA.debugLine="Private txt As EditText = Control";
...
if (_control.getObjectOrNull() instanceof anywheresoftware.b4a.objects.SpinnerWrapper.B4ASpinner) { 
 //BA.debugLineNum = 23;BA.debugLine="Private sp As Spinner = Control";
...
_sp.setTextColor(_textcolor);
 ...
 //BA.debugLineNum = 27;BA.debugLine="Control.Background = Helper_Gradient(ColorA, Colo";
_control.setBackground((android.graphics.drawable.Drawable)(_helper_gradient(_ba,_colora,_colorb,_colorpresseda,_colorpressedb,_colordisableda,_colordisabledb,_cornerround).getObject()));
 //BA.debugLineNum = 28;BA.debugLine="Remove_Padding(Control)";
...
int[] _states = null;
 //BA.debugLineNum = 30;BA.debugLine="Private Sub Helper_Gradient(ColorA As Int, ColorB";
 //BA.debugLineNum = 31;BA.debugLine="Private colsEnabled(2) As Int				'Дефинира два цв";
_colsenabled = new int[(int) (2)];
;
 //BA.debugLineNum = 32;BA.debugLine="colsEnabled(0) = ColorA";
_colsenabled[(int) (0)] = _colora;
 //BA.debugLineNum = 33;BA.debugLine="colsEnabled(1) = ColorB";
_colsenabled[(int) (1)] = _colorb;
 //BA.debugLineNum = 34;BA.debugLine="Private gdwEnabled As GradientDrawable		'Дефинира";
_gdwenabled = new anywheresoftware.b4a.objects.drawable.GradientDrawable();
 //BA.debugLineNum = 35;BA.debugLine="gdwEnabled.Initialize(\"TOP_BOTTOM\", colsEnabled)";
_gdwenabled.Initialize(BA.getEnumFromString(android.graphics.drawable.GradientDrawable.Orientation.class,"TOP_BOTTOM"),_colsenabled);
 //BA.debugLineNum = 36;BA.debugLine="gdwEnabled.CornerRadius = CornerRound";
_gdwenabled.setCornerRadius((float) (_cornerround));
 //BA.debugLineNum = 37;BA.debugLine="Private colsPressed(2) As Int				'Дефинира два цв";
_colspressed = new int[(int) (2)];
;
 //BA.debugLineNum = 38;BA.debugLine="colsPressed(0) = ColorPressedA";
_colspressed[(int) (0)] = _colorpresseda;
 //BA.debugLineNum = 39;BA.debugLine="colsPressed(1) = ColorPressedB";
_colspressed[(int) (1)] = _colorpressedb;
 //BA.debugLineNum = 40;BA.debugLine="Private gdwPressed As GradientDrawable		'Дефинира";
_gdwpressed = new anywheresoftware.b4a.objects.drawable.GradientDrawable();
 //BA.debugLineNum = 41;BA.debugLine="gdwPressed.Initialize(\"TOP_BOTTOM\", colsPressed)";
_gdwpressed.Initialize(BA.getEnumFromString(android.graphics.drawable.GradientDrawable.Orientation.class,"TOP_BOTTOM"),_colspressed);
 //BA.debugLineNum = 42;BA.debugLine="gdwPressed.CornerRadius = CornerRound";
_gdwpressed.setCornerRadius((float) (_cornerround));
 //BA.debugLineNum = 43;BA.debugLine="Private colsDisabled(2) As Int				'Дефинира два ц";
_colsdisabled = new int[(int) (2)];
;
 //BA.debugLineNum = 44;BA.debugLine="colsDisabled(0) = ColorDisabledA";
_colsdisabled[(int) (0)] = _colordisableda;
 //BA.debugLineNum = 45;BA.debugLine="colsDisabled(1) = ColorDisabledB";
_colsdisabled[(int) (1)] = _colordisabledb;
 //BA.debugLineNum = 46;BA.debugLine="Private gdwDisabled As GradientDrawable		'Дефинир";
_gdwdisabled = new anywheresoftware.b4a.objects.drawable.GradientDrawable();
 //BA.debugLineNum = 47;BA.debugLine="gdwDisabled.Initialize(\"TOP_BOTTOM\", colsDisabled";
_gdwdisabled.Initialize(BA.getEnumFromString(android.graphics.drawable.GradientDrawable.Orientation.class,"TOP_BOTTOM"),_colsdisabled);
 //BA.debugLineNum = 48;BA.debugLine="gdwDisabled.CornerRadius = CornerRound";
_gdwdisabled.setCornerRadius((float) (_cornerround));
 //BA.debugLineNum = 49;BA.debugLine="Private stdGradient As StateListDrawable	'Дефинир";
_stdgradient = new anywheresoftware.b4a.objects.drawable.StateListDrawable();
 //BA.debugLineNum = 50;BA.debugLine="stdGradient.Initialize";
_stdgradient.Initialize();
 //BA.debugLineNum = 51;BA.debugLine="Private states(2) As Int";
_states = new int[(int) (2)];
;
 //BA.debugLineNum = 52;BA.debugLine="states(0) = stdGradient.State_Enabled";
_states[(int) (0)] = _stdgradient.State_Enabled;
 //BA.debugLineNum = 53;BA.debugLine="states(1) = -stdGradient.State_Pressed";
_states[(int) (1)] = (int) (-_stdgradient.State_Pressed);
 //BA.debugLineNum = 54;BA.debugLine="stdGradient.addState2(states, gdwEnabled)";
...
;
 //BA.debugLineNum = 56;BA.debugLine="states(0) = stdGradient.State_Pressed";
_states[(int) (0)] = _stdgradient.State_Pressed;
 //BA.debugLineNum = 57;BA.debugLine="stdGradient.addState2(states, gdwPressed)";
_stdgradient.AddState2(_states,(android.graphics.drawable.Drawable)(_gdwpressed.getObject()));
 //BA.debugLineNum = 58;BA.debugLine="Private states(1) As Int";
_states = new int[(int) (1)];
;
 //BA.debugLineNum = 59;BA.debugLine="states(0) = stdGradient.State_Disabled";
_states[(int) (0)] = _stdgradient.State_Disabled;
 //BA.debugLineNum = 60;BA.debugLine="stdGradient.addState2(states, gdwDisabled)";
_stdgradient.AddState2(_states,(android.graphics.drawable.Drawable)(_gdwdisabled.getObject()));
 //BA.debugLineNum = 61;BA.debugLine="Return stdGradient							'Връща градиента като па";
...
_teamname = "";
 //BA.debugLineNum = 8;BA.debugLine="Public tvResult As String  = Null";
_tvresult = BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Null);
 //BA.debugLineNum = 9;BA.debugLine="Public avResult As String  = Null";
_avresult = BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Null);
 //BA.debugLineNum = 10;BA.debugLine="Public exeResult As String = Null";
_exeresult = BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Null);
...
anywheresoftware.b4a.agraham.reflection.Reflection _reflect = null;
 //BA.debugLineNum = 64;BA.debugLine="Public Sub Remove_Padding (obj As Object)		'Премах";
 //BA.debugLineNum = 65;BA.debugLine="Private pad = 0dip As Int";
_pad = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0));
 //BA.debugLineNum = 66;BA.debugLine="Private reflect As Reflector";
_reflect = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 67;BA.debugLine="reflect.Target = obj";
_reflect.Target = _obj;
 //BA.debugLineNum = 68;BA.debugLine="reflect.RunMethod4(\"setPadding\", Array As Object(";
