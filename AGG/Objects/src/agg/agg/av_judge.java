...
RDebugUtils.currentLine=1572865;
 //BA.debugLineNum = 1572865;BA.debugLine="avPanel.Initialize(\"\")";
__ref._avpanel.Initialize(ba,"");
RDebugUtils.currentLine=1572866;
 //BA.debugLineNum = 1572866;BA.debugLine="For i = 0 To 3";
{
final int step2 = 1;
...
RDebugUtils.currentLine=1572867;
 //BA.debugLineNum = 1572867;BA.debugLine="page(i).Initialize(\"\")";
__ref._page[_i].Initialize(ba,"");
 }
};
RDebugUtils.currentLine=1572869;
 //BA.debugLineNum = 1572869;BA.debugLine="For i = 0 To 34";
{
final int step5 = 1;
...
RDebugUtils.currentLine=1572870;
 //BA.debugLineNum = 1572870;BA.debugLine="label(i).Initialize(\"\")";
__ref._label[_i].Initialize(ba,"");
 }
};
RDebugUtils.currentLine=1572872;
 //BA.debugLineNum = 1572872;BA.debugLine="For i = 0 To 34";
{
final int step8 = 1;
...
RDebugUtils.currentLine=1572873;
 //BA.debugLineNum = 1572873;BA.debugLine="chekpointbox(i).Initialize(\"check\")";
__ref._chekpointbox[_i].Initialize(ba,"check");
 }
};
RDebugUtils.currentLine=1572875;
 //BA.debugLineNum = 1572875;BA.debugLine="downPanel.Initialize(\"\")";
__ref._downpanel.Initialize(ba,"");
RDebugUtils.currentLine=1572876;
 //BA.debugLineNum = 1572876;BA.debugLine="btnready.Initialize(\"ready\")";
...
RDebugUtils.currentLine=1900544;
 //BA.debugLineNum = 1900544;BA.debugLine="Public Sub asView As Panel";
RDebugUtils.currentLine=1900545;
 //BA.debugLineNum = 1900545;BA.debugLine="Return avPanel";
...
RDebugUtils.currentLine=1638432;
 //BA.debugLineNum = 1638432;BA.debugLine="avPanel.AddView(Pager, 0dip, 35dip + 2dip, avPane";
...
RDebugUtils.currentLine=1638434;
 //BA.debugLineNum = 1638434;BA.debugLine="avPanel.AddView(downPanel, 0, avPanel.Height - 35";
...
RDebugUtils.currentLine=1638435;
 //BA.debugLineNum = 1638435;BA.debugLine="avPanel.AddView(Line2, 0dip, avPanel.Height - (35";
...
RDebugUtils.currentLine=1638437;
 //BA.debugLineNum = 1638437;BA.debugLine="downPanel.AddView(btnready, downPanel.Width - 12%";
...
RDebugUtils.currentLine=1638439;
 //BA.debugLineNum = 1638439;BA.debugLine="Dim lblHeigh As Int = (avPanel.Height - downPanel";
_lblheigh = (int) ((__ref._avpanel.getHeight()-__ref._downpanel.getHeight())/(double)7);
RDebugUtils.currentLine=1638440;
 //BA.debugLineNum = 1638440;BA.debugLine="Log(lblHeigh)";
__c.Log(BA.NumberToString(_lblheigh));
RDebugUtils.currentLine=1638441;
 //BA.debugLineNum = 1638441;BA.debugLine="page(0).AddView(label(0), 2%x, 5%y, 50%x, 10%y)";
...
RDebugUtils.currentLine=1638442;
 //BA.debugLineNum = 1638442;BA.debugLine="label(0).Text = Main.translate.GetString(\"AVlabal";
...
RDebugUtils.currentLine=1638443;
 //BA.debugLineNum = 1638443;BA.debugLine="label(0).TextColor = Colors.White";
__ref._label[(int) (0)].setTextColor(__c.Colors.White);
RDebugUtils.currentLine=1638445;
 //BA.debugLineNum = 1638445;BA.debugLine="page(0).AddView(chekpointbox(0), label(0).left +";
...
RDebugUtils.currentLine=1638446;
 //BA.debugLineNum = 1638446;BA.debugLine="chekpointbox(0).Text = Main.translate.GetString(\"";
...
RDebugUtils.currentLine=1638449;
 //BA.debugLineNum = 1638449;BA.debugLine="For i = 1 To 7";
{
final int step31 = 1;
...
RDebugUtils.currentLine=1638450;
 //BA.debugLineNum = 1638450;BA.debugLine="page(0).AddView(label(i), 2%x, label(i - 1).Top";
...
RDebugUtils.currentLine=1638451;
 //BA.debugLineNum = 1638451;BA.debugLine="label(i).Text = Main.translate.GetString(\"AVlaba";
...
RDebugUtils.currentLine=1638452;
 //BA.debugLineNum = 1638452;BA.debugLine="label(i).TextColor = Colors.White";
__ref._label[_i].setTextColor(__c.Colors.White);
RDebugUtils.currentLine=1638453;
 //BA.debugLineNum = 1638453;BA.debugLine="page(0).AddView(chekpointbox(i), label(i).left +";
...
RDebugUtils.currentLine=1638454;
 //BA.debugLineNum = 1638454;BA.debugLine="chekpointbox(i).Text = Main.translate.GetString(";
...
RDebugUtils.currentLine=1638458;
 //BA.debugLineNum = 1638458;BA.debugLine="page(1).AddView(label(8), 2%x, 5%y, 50%x, 10%y)";
...
RDebugUtils.currentLine=1638459;
 //BA.debugLineNum = 1638459;BA.debugLine="label(8).Text = Main.translate.GetString(\"AVlabal";
...
RDebugUtils.currentLine=1638460;
 //BA.debugLineNum = 1638460;BA.debugLine="label(8).TextColor = Colors.White";
__ref._label[(int) (8)].setTextColor(__c.Colors.White);
RDebugUtils.currentLine=1638462;
 //BA.debugLineNum = 1638462;BA.debugLine="page(1).AddView(chekpointbox(8), label(8).left +";
...
RDebugUtils.currentLine=1638463;
 //BA.debugLineNum = 1638463;BA.debugLine="chekpointbox(8).Text = Main.translate.GetString(\"";
...
RDebugUtils.currentLine=1638465;
 //BA.debugLineNum = 1638465;BA.debugLine="For i = 9 To 15";
{
final int step43 = 1;
...
RDebugUtils.currentLine=1638466;
 //BA.debugLineNum = 1638466;BA.debugLine="page(1).AddView(label(i), 2%x, label(i - 1).Top";
...
RDebugUtils.currentLine=1638467;
 //BA.debugLineNum = 1638467;BA.debugLine="label(i).Text = Main.translate.GetString(\"AVlaba";
__ref._label[_i].setText(BA.ObjectToCharSequence(_main._translate._getstring(null,"AVlabal"+BA.NumberToString(_i))));
RDebugUtils.currentLine=1638468;
 //BA.debugLineNum = 1638468;BA.debugLine="label(i).TextColor = Colors.White";
__ref._label[_i].setTextColor(__c.Colors.White);
RDebugUtils.currentLine=1638469;
 //BA.debugLineNum = 1638469;BA.debugLine="page(1).AddView(chekpointbox(i), label(i).left +";
...
RDebugUtils.currentLine=1638470;
 //BA.debugLineNum = 1638470;BA.debugLine="chekpointbox(i).Text = Main.translate.GetString(";
__ref._chekpointbox[_i].setText(BA.ObjectToCharSequence(_main._translate._getstring(null,"Check"+BA.NumberToString(_i))));
 }
};
RDebugUtils.currentLine=1638474;
 //BA.debugLineNum = 1638474;BA.debugLine="page(2).AddView(label(16),2%x, 5%y, 50%x, 10%y)";
...
RDebugUtils.currentLine=1638475;
 //BA.debugLineNum = 1638475;BA.debugLine="label(16).Text = Main.translate.GetString(\"AVlaba";
...
RDebugUtils.currentLine=1638476;
 //BA.debugLineNum = 1638476;BA.debugLine="label(16).TextColor = Colors.White";
__ref._label[(int) (16)].setTextColor(__c.Colors.White);
RDebugUtils.currentLine=1638477;
 //BA.debugLineNum = 1638477;BA.debugLine="page(2).AddView(chekpointbox(16), label(16).left";
...
RDebugUtils.currentLine=1638478;
 //BA.debugLineNum = 1638478;BA.debugLine="chekpointbox(16).Text = Main.translate.GetString(";
...
RDebugUtils.currentLine=1638481;
 //BA.debugLineNum = 1638481;BA.debugLine="For i = 17 To 23";
{
final int step55 = 1;
...
RDebugUtils.currentLine=1638482;
 //BA.debugLineNum = 1638482;BA.debugLine="page(2).AddView(label(i), 2%x, label(i - 1).Top";
...
RDebugUtils.currentLine=1638483;
 //BA.debugLineNum = 1638483;BA.debugLine="label(i).Text = Main.translate.GetString(\"AVlaba";
__ref._label[_i].setText(BA.ObjectToCharSequence(_main._translate._getstring(null,"AVlabal"+BA.NumberToString(_i))));
RDebugUtils.currentLine=1638484;
 //BA.debugLineNum = 1638484;BA.debugLine="label(i).TextColor = Colors.White";
__ref._label[_i].setTextColor(__c.Colors.White);
RDebugUtils.currentLine=1638485;
 //BA.debugLineNum = 1638485;BA.debugLine="page(2).AddView(chekpointbox(i), label(i).left +";
...
RDebugUtils.currentLine=1638486;
 //BA.debugLineNum = 1638486;BA.debugLine="chekpointbox(i).Text = Main.translate.GetString(";
__ref._chekpointbox[_i].setText(BA.ObjectToCharSequence(_main._translate._getstring(null,"Check"+BA.NumberToString(_i))));
 }
};
RDebugUtils.currentLine=1638490;
 //BA.debugLineNum = 1638490;BA.debugLine="page(3).AddView(label(24), 2%x, 5%y, 50%x, 10%y)";
...
RDebugUtils.currentLine=1638491;
 //BA.debugLineNum = 1638491;BA.debugLine="label(24).Text = Main.translate.GetString(\"AVlaba";
...
RDebugUtils.currentLine=1638492;
 //BA.debugLineNum = 1638492;BA.debugLine="label(24).TextColor = Colors.White";
__ref._label[(int) (24)].setTextColor(__c.Colors.White);
RDebugUtils.currentLine=1638493;
 //BA.debugLineNum = 1638493;BA.debugLine="page(3).AddView(chekpointbox(24), label(24).left";
...
RDebugUtils.currentLine=1638494;
 //BA.debugLineNum = 1638494;BA.debugLine="chekpointbox(24).Text = Main.translate.GetString(";
...
RDebugUtils.currentLine=1638496;
 //BA.debugLineNum = 1638496;BA.debugLine="For i = 25 To 31";
{
final int step67 = 1;
...
RDebugUtils.currentLine=1638497;
 //BA.debugLineNum = 1638497;BA.debugLine="page(3).AddView(label(i), 2%x, label(i - 1).Top";
...
RDebugUtils.currentLine=1638498;
 //BA.debugLineNum = 1638498;BA.debugLine="label(i).Text = Main.translate.GetString(\"AVlaba";
__ref._label[_i].setText(BA.ObjectToCharSequence(_main._translate._getstring(null,"AVlabal"+BA.NumberToString(_i))));
RDebugUtils.currentLine=1638499;
 //BA.debugLineNum = 1638499;BA.debugLine="label(i).TextColor = Colors.White";
__ref._label[_i].setTextColor(__c.Colors.White);
RDebugUtils.currentLine=1638500;
 //BA.debugLineNum = 1638500;BA.debugLine="page(3).AddView(chekpointbox(i), label(i).left +";
...
RDebugUtils.currentLine=1638501;
 //BA.debugLineNum = 1638501;BA.debugLine="chekpointbox(i).Text = Main.translate.GetString(";
__ref._chekpointbox[_i].setText(BA.ObjectToCharSequence(_main._translate._getstring(null,"Check"+BA.NumberToString(_i))));
 }
};
RDebugUtils.currentLine=1638504;
 //BA.debugLineNum = 1638504;BA.debugLine="End Sub";
return "";
}
public double  _finaavscore(agg.agg.av_judge __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="av_judge";
if (Debug.shouldDelegate(ba, "finaavscore"))
	return (Double) Debug.delegate(ba, "finaavscore", null);
RDebugUtils.currentLine=1769472;
 //BA.debugLineNum = 1769472;BA.debugLine="Public Sub finaAVscore As Double";
RDebugUtils.currentLine=1769473;
 //BA.debugLineNum = 1769473;BA.debugLine="Log(\"AVSCORE:\"&avScore)";
__c.Log("AVSCORE:"+BA.NumberToString(__ref._avscore));
RDebugUtils.currentLine=1769474;
 //BA.debugLineNum = 1769474;BA.debugLine="Return avScore";
...
RDebugUtils.currentLine=1703936;
 //BA.debugLineNum = 1703936;BA.debugLine="Private Sub check_CheckedChange(Checked As Boolean";
RDebugUtils.currentLine=1703937;
 //BA.debugLineNum = 1703937;BA.debugLine="If Checked = True Then";
if (_checked==__c.True) { 
RDebugUtils.currentLine=1703938;
 //BA.debugLineNum = 1703938;BA.debugLine="avScore = avScore + 0.1";
__ref._avscore = __ref._avscore+0.1;
RDebugUtils.currentLine=1703939;
 //BA.debugLineNum = 1703939;BA.debugLine="Log(avScore)";
__c.Log(BA.NumberToString(__ref._avscore));
 }else {
RDebugUtils.currentLine=1703941;
 //BA.debugLineNum = 1703941;BA.debugLine="avScore = avScore - 0.1";
__ref._avscore = __ref._avscore-0.1;
 };
...
RDebugUtils.currentLine=1507329;
 //BA.debugLineNum = 1507329;BA.debugLine="Public avPanel As Panel";
_avpanel = new anywheresoftware.b4a.objects.PanelWrapper();
RDebugUtils.currentLine=1507330;
 //BA.debugLineNum = 1507330;BA.debugLine="Public Pager As AHViewPager";
_pager = new de.amberhome.viewpager.AHViewPager();
RDebugUtils.currentLine=1507331;
 //BA.debugLineNum = 1507331;BA.debugLine="Public Container As AHPageContainer";
_container = new de.amberhome.viewpager.AHPageContainer();
RDebugUtils.currentLine=1507332;
 //BA.debugLineNum = 1507332;BA.debugLine="Private page(4) As Panel";
...
RDebugUtils.currentLine=1507333;
 //BA.debugLineNum = 1507333;BA.debugLine="Private label(35) As Label";
...
RDebugUtils.currentLine=1507334;
 //BA.debugLineNum = 1507334;BA.debugLine="Private chekpointbox(35) As CheckBox";
...
RDebugUtils.currentLine=1507335;
 //BA.debugLineNum = 1507335;BA.debugLine="Dim Tabs As AHViewPagerTabs";
_tabs = new de.amberhome.viewpager.AHViewPagerTabs();
RDebugUtils.currentLine=1507336;
 //BA.debugLineNum = 1507336;BA.debugLine="Dim Line As Panel";
_line = new anywheresoftware.b4a.objects.PanelWrapper();
RDebugUtils.currentLine=1507337;
 //BA.debugLineNum = 1507337;BA.debugLine="Dim Line2 As Panel";
_line2 = new anywheresoftware.b4a.objects.PanelWrapper();
RDebugUtils.currentLine=1507338;
 //BA.debugLineNum = 1507338;BA.debugLine="Dim downPanel As Panel";
_downpanel = new anywheresoftware.b4a.objects.PanelWrapper();
RDebugUtils.currentLine=1507339;
 //BA.debugLineNum = 1507339;BA.debugLine="Dim btnready As Button";
_btnready = new anywheresoftware.b4a.objects.ButtonWrapper();
RDebugUtils.currentLine=1507340;
 //BA.debugLineNum = 1507340;BA.debugLine="Public avScore As Double";
_avscore = 0;
...
RDebugUtils.currentLine=1835008;
 //BA.debugLineNum = 1835008;BA.debugLine="Private Sub ready_Click";
RDebugUtils.currentLine=1835009;
 //BA.debugLineNum = 1835009;BA.debugLine="CallSub(Main, \"FinalClick\")";
__c.CallSubDebug(ba,(Object)(_main.getObject()),"FinalClick");
RDebugUtils.currentLine=1835010;
 //BA.debugLineNum = 1835010;BA.debugLine="finaAVscore";
__ref._finaavscore(null);
