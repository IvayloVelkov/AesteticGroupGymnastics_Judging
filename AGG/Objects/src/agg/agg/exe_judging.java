...
public String  _addpan_click() throws Exception{
 //BA.debugLineNum = 101;BA.debugLine="Public Sub addPan_Click";
 //BA.debugLineNum = 102;BA.debugLine="exeScore = exeScore + 0.1";
_exescore = _exescore+0.1;
 //BA.debugLineNum = 103;BA.debugLine="Log(exeScore)";
__c.Log(BA.NumberToString(_exescore));
 //BA.debugLineNum = 104;BA.debugLine="End Sub";
return "";
}
public anywheresoftware.b4a.objects.PanelWrapper  _asview() throws Exception{
 //BA.debugLineNum = 126;BA.debugLine="Public Sub asView As Panel";
 //BA.debugLineNum = 127;BA.debugLine="Return exePanel";
...
_container.Initialize(ba);
 //BA.debugLineNum = 39;BA.debugLine="Container.AddPage(page(0), Main.translate.GetStri";
...
_col = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
 //BA.debugLineNum = 54;BA.debugLine="Col.Initialize(0xff149be0, 0)";
...
_page[(int) (0)].AddView((android.view.View)(_label[(int) (0)].getObject()),__c.PerXToCurrent((float) (2),ba),__c.PerYToCurrent((float) (5),ba),__c.PerXToCurrent((float) (50),ba),__c.PerYToCurrent((float) (10),ba));
 //BA.debugLineNum = 73;BA.debugLine="label(0).Text = Main.translate.GetString(\"Exelaba";
...
_label[(int) (0)].setTextColor(__c.Colors.White);
 //BA.debugLineNum = 76;BA.debugLine="page(0).AddView(btnPoints(0), label(0).left + lab";
_page[(int) (0)].AddView((android.view.View)(_btnpoints[(int) (0)].getObject()),(int) (_label[(int) (0)].getLeft()+_label[(int) (0)].getWidth()+__c.PerXToCurrent((float) (10),ba)),_label[(int) (0)].getTop(),__c.PerXToCurrent((float) (15),ba),__c.PerYToCurrent((float) (10),ba));
 //BA.debugLineNum = 77;BA.debugLine="btnPoints(0).Text = \"-\" & HelperFunctions.TvScore";
_btnpoints[(int) (0)].setText(BA.ObjectToCharSequence("-"+_helperfunctions._tvscore1));
 //BA.debugLineNum = 78;BA.debugLine="HelperFunctions.Apply_ViewStyle(btnPoints(0),Colo";
_helperfunctions._apply_viewstyle(ba,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_btnpoints[(int) (0)].getObject())),__c.Colors.White,(int) (0xff4ac2ff),(int) (0xff149be0),(int) (0xff2cb7ff),(int) (0xff2cb7ff),(int) (0x66040509),(int) (0x66040509),(int) (60));
 //BA.debugLineNum = 79;BA.debugLine="btnPoints(0).Padding = Array As Int(15,0,0,0)";
_btnpoints[(int) (0)].setPadding(new int[]{(int) (15),(int) (0),(int) (0),(int) (0)});
 //BA.debugLineNum = 80;BA.debugLine="btnPoints(0).SingleLine = True";
_btnpoints[(int) (0)].setSingleLine(__c.True);
 //BA.debugLineNum = 83;BA.debugLine="For i = 1 To 7";
{
final int step29 = 1;
final int limit29 = (int) (7);
_i = (int) (1) ;
for (;_i <= limit29 ;_i = _i + step29 ) {
 //BA.debugLineNum = 84;BA.debugLine="page(0).AddView(label(i), 2%x, label(i - 1).Top";
_page[(int) (0)].AddView((android.view.View)(_label[_i].getObject()),__c.PerXToCurrent((float) (2),ba),(int) (_label[(int) (_i-1)].getTop()+_label[(int) (_i-1)].getHeight()+__c.DipToCurrent((int) (3))),__c.PerXToCurrent((float) (50),ba),__c.PerYToCurrent((float) (10),ba));
 //BA.debugLineNum = 85;BA.debugLine="label(i).Text = Main.translate.GetString(\"Exelab";
_label[_i].setText(BA.ObjectToCharSequence(_main._translate._getstring("Exelabal"+BA.NumberToString(_i))));
 //BA.debugLineNum = 86;BA.debugLine="label(i).TextColor = Colors.White";
_label[_i].setTextColor(__c.Colors.White);
 }
};
 //BA.debugLineNum = 89;BA.debugLine="For i = 1 To 6";
{
final int step34 = 1;
final int limit34 = (int) (6);
_i = (int) (1) ;
for (;_i <= limit34 ;_i = _i + step34 ) {
 //BA.debugLineNum = 90;BA.debugLine="page(0).AddView(btnPoints(i), label(i).left + la";
_page[(int) (0)].AddView((android.view.View)(_btnpoints[_i].getObject()),(int) (_label[_i].getLeft()+_label[_i].getWidth()+__c.PerXToCurrent((float) (10),ba)),_label[_i].getTop(),__c.PerXToCurrent((float) (15),ba),__c.PerYToCurrent((float) (10),ba));
 //BA.debugLineNum = 91;BA.debugLine="btnPoints(i).Text = \"-\" & HelperFunctions.TvScor";
_btnpoints[_i].setText(BA.ObjectToCharSequence("-"+_helperfunctions._tvscore1));
 //BA.debugLineNum = 92;BA.debugLine="HelperFunctions.Apply_ViewStyle(btnPoints(i),Col";
_helperfunctions._apply_viewstyle(ba,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_btnpoints[_i].getObject())),__c.Colors.White,(int) (0xff4ac2ff),(int) (0xff149be0),(int) (0xff2cb7ff),(int) (0xff2cb7ff),(int) (0x66040509),(int) (0x66040509),(int) (60));
 //BA.debugLineNum = 93;BA.debugLine="btnPoints(i).Padding = Array As Int(15,0,0,0)";
_btnpoints[_i].setPadding(new int[]{(int) (15),(int) (0),(int) (0),(int) (0)});
 //BA.debugLineNum = 94;BA.debugLine="btnPoints(i).SingleLine = True";
_btnpoints[_i].setSingleLine(__c.True);
 }
};
 //BA.debugLineNum = 97;BA.debugLine="page(0).AddView(chekpointbox, label(7).left + lab";
_page[(int) (0)].AddView((android.view.View)(_chekpointbox.getObject()),(int) (_label[(int) (7)].getLeft()+_label[(int) (7)].getWidth()+__c.PerXToCurrent((float) (10),ba)),_label[(int) (7)].getTop(),__c.PerXToCurrent((float) (15),ba),__c.PerYToCurrent((float) (10),ba));
 //BA.debugLineNum = 98;BA.debugLine="chekpointbox.Text = \"-\" & HelperFunctions.TvScore";
...
public String  _check_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 106;BA.debugLine="Private Sub check_CheckedChange(Checked As Boolean";
...
_exescore = _exescore+0.1;
 //BA.debugLineNum = 109;BA.debugLine="Log(exeScore)";
__c.Log(BA.NumberToString(_exescore));
 }else {
 //BA.debugLineNum = 111;BA.debugLine="exeScore = exeScore - 0.1";
_exescore = _exescore-0.1;
 };
...
public double  _finalexescore() throws Exception{
 //BA.debugLineNum = 115;BA.debugLine="Public Sub finalEXEscore As Double";
 //BA.debugLineNum = 116;BA.debugLine="exeScore = maxValue - exeScore";
_exescore = _maxvalue-_exescore;
 //BA.debugLineNum = 117;BA.debugLine="Log(\"EXESCORE:\"&exeScore)";
__c.Log("EXESCORE:"+BA.NumberToString(_exescore));
 //BA.debugLineNum = 118;BA.debugLine="Return exeScore";
...
_btnready.Initialize(ba,"ready");
 //BA.debugLineNum = 31;BA.debugLine="HelperFunctions.Apply_ViewStyle(btnready,Colors.W";
_helperfunctions._apply_viewstyle(ba,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_btnready.getObject())),__c.Colors.White,(int) (0xff4ac2ff),(int) (0xff149be0),(int) (0xff2cb7ff),(int) (0xff2cb7ff),(int) (0x66040509),(int) (0x66040509),(int) (20));
 //BA.debugLineNum = 32;BA.debugLine="btnready.Text = Main.translate.GetString(\"readyBt";
...
public String  _ready_click() throws Exception{
 //BA.debugLineNum = 121;BA.debugLine="Private Sub ready_Click";
 //BA.debugLineNum = 122;BA.debugLine="CallSub(Main, \"FinalClick\")";
__c.CallSubNew(ba,(Object)(_main.getObject()),"FinalClick");
 //BA.debugLineNum = 123;BA.debugLine="finalEXEscore";
_finalexescore();
