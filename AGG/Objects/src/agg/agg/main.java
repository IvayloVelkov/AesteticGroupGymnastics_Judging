...
public agg.agg.settingsscreen _settingsscr = null;
...
_translate._initialize(processBA);
 //BA.debugLineNum = 38;BA.debugLine="UISizes.Initialize";
mostCurrent._uisizes._initialize(mostCurrent.activityBA);
 //BA.debugLineNum = 39;BA.debugLine="Load_Language";
_load_language();
...
mostCurrent._final._asview().setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 73;BA.debugLine="SettingsScr.Initialize";
mostCurrent._settingsscr._initialize(mostCurrent.activityBA);
 //BA.debugLineNum = 74;BA.debugLine="Activity.AddView(SettingsScr.asView, 0, 0, 100%x,";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._settingsscr._asview().getObject()),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 75;BA.debugLine="SettingsScr.asView.Visible = False";
mostCurrent._settingsscr._asview().setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 76;BA.debugLine="SettingsScr.asView.Enabled = False";
mostCurrent._settingsscr._asview().setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 79;BA.debugLine="conn.Initialize";
...
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 178;BA.debugLine="If avJ.asView.Visible = True Then";
if (mostCurrent._avj._asview().getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 179;BA.debugLine="typeJ.asView.Visible = True";
mostCurrent._typej._asview().setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 180;BA.debugLine="avJ.asView.Visible = False";
mostCurrent._avj._asview().setVisible(anywheresoftware.b4a.keywords.Common.False);
 }else if(mostCurrent._tvj._asview().getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 182;BA.debugLine="tvJ.asView.Visible = False";
mostCurrent._tvj._asview().setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 183;BA.debugLine="typeJ.asView.Visible = True";
mostCurrent._typej._asview().setVisible(anywheresoftware.b4a.keywords.Common.True);
 }else if(mostCurrent._exej._asview().getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 185;BA.debugLine="exeJ.asView.Visible = False";
mostCurrent._exej._asview().setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 186;BA.debugLine="typeJ.asView.Visible = True";
mostCurrent._typej._asview().setVisible(anywheresoftware.b4a.keywords.Common.True);
 }else if(mostCurrent._typej._asview().getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 188;BA.debugLine="typeJ.asView.Visible = False";
mostCurrent._typej._asview().setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 189;BA.debugLine="Login.asView.Visible = True";
mostCurrent._login._asview().setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 190;BA.debugLine="Login.btnloginPanel.Enabled = True";
mostCurrent._login._btnloginpanel.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 ...
 //BA.debugLineNum = 192;BA.debugLine="Select scActive";
switch (_scactive) {
case 1: {
 //BA.debugLineNum = 194;BA.debugLine="avJ.asView.Visible = True";
mostCurrent._avj._asview().setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 195;BA.debugLine="final.asView.Visible = False";
mostCurrent._final._asview().setVisible(anywheresoftware.b4a.keywords.Common.False);
 break; }
case 2: {
 //BA.debugLineNum = 197;BA.debugLine="tvJ.asView.Visible = True";
mostCurrent._tvj._asview().setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 198;BA.debugLine="final.asView.Visible = False";
mostCurrent._final._asview().setVisible(anywheresoftware.b4a.keywords.Common.False);
 break; }
case 3: {
 //BA.debugLineNum = 200;BA.debugLine="exeJ.asView.Visible = True";
mostCurrent._exej._asview().setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 201;BA.debugLine="final.asView.Visible = False";
mostCurrent._final._asview().setVisible(anywheresoftware.b4a.keywords.Common.False);
 break; }
}
;
 }else if(mostCurrent._settingsscr._asview().getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 204;BA.debugLine="SettingsScr.asView.Visible = False";
mostCurrent._settingsscr._asview().setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 205;BA.debugLine="Login.asView.Visible = True";
mostCurrent._login._asview().setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 206;BA.debugLine="Login.btnloginPanel.Enabled = True";
mostCurrent._login._btnloginpanel.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 };
...
public static String  _av_click() throws Exception{
 //BA.debugLineNum = 110;BA.debugLine="Public Sub AV_Click";
 //BA.debugLineNum = 111;BA.debugLine="typeJ.asView.Visible = False";
mostCurrent._typej._asview().setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 112;BA.debugLine="typeJ.asView.Enabled = False";
mostCurrent._typej._asview().setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 114;BA.debugLine="avJ.asView.Visible = True";
mostCurrent._avj._asview().setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 115;BA.debugLine="avJ.asView.Enabled = True";
mostCurrent._avj._asview().setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 116;BA.debugLine="scActive = 1";
_scactive = (int) (1);
 //BA.debugLineNum = 117;BA.debugLine="ProgramData.activeJ = scActive";
mostCurrent._programdata._activej = _scactive;
 //BA.debugLineNum = 118;BA.debugLine="End Sub";
return "";
}
public static String  _connect() throws Exception{
 //BA.debugLineNum = 167;BA.debugLine="Public Sub Connect";
 //BA.debugLineNum = 168;BA.debugLine="conn.PerformUpload()";
mostCurrent._conn._performupload();
 //BA.debugLineNum = 169;BA.debugLine="End Sub";
return "";
}
public static String  _connecttodatabase() throws Exception{
 //BA.debugLineNum = 171;BA.debugLine="Public Sub ConnectToDatabase";
 //BA.debugLineNum = 172;BA.debugLine="conn.setDatabase(ProgramData.dbServerAddress, Pro";
mostCurrent._conn._setdatabase(mostCurrent._programdata._dbserveraddress,mostCurrent._programdata._dbbasename,mostCurrent._programdata._dbusername,mostCurrent._programdata._dbpassword);
 //BA.debugLineNum = 173;BA.debugLine="End Sub";
return "";
}
public static String  _exe_click() throws Exception{
 //BA.debugLineNum = 130;BA.debugLine="Public Sub EXE_Click";
 //BA.debugLineNum = 131;BA.debugLine="typeJ.asView.Visible = False";
mostCurrent._typej._asview().setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 132;BA.debugLine="typeJ.asView.Enabled = False";
mostCurrent._typej._asview().setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 134;BA.debugLine="exeJ.asView.Visible = True";
mostCurrent._exej._asview().setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 135;BA.debugLine="exeJ.asView.Enabled = True";
mostCurrent._exej._asview().setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 136;BA.debugLine="scActive = 3";
_scactive = (int) (3);
 //BA.debugLineNum = 137;BA.debugLine="ProgramData.activeJ = scActive";
mostCurrent._programdata._activej = _scactive;
 //BA.debugLineNum = 139;BA.debugLine="End Sub";
return "";
}
public static String  _finalclick() throws Exception{
 //BA.debugLineNum = 141;BA.debugLine="Public Sub FinalClick";
 //BA.debugLineNum = 142;BA.debugLine="If avJ.asView.Visible = True Then";
if (mostCurrent._avj._asview().getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 143;BA.debugLine="avJ.asView.Visible = False";
mostCurrent._avj._asview().setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 144;BA.debugLine="avJ.asView.Enabled = False";
mostCurrent._avj._asview().setEnabled(anywheresoftware.b4a.keywords.Common.False);
 }else if(mostCurrent._tvj._asview().getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 146;BA.debugLine="tvJ.asView.Visible = False";
mostCurrent._tvj._asview().setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 147;BA.debugLine="tvJ.asView.Enabled = False";
mostCurrent._tvj._asview().setEnabled(anywheresoftware.b4a.keywords.Common.False);
 }else if(mostCurrent._exej._asview().getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 149;BA.debugLine="exeJ.asView.Visible = False";
mostCurrent._exej._asview().setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 150;BA.debugLine="exeJ.asView.Enabled = False";
mostCurrent._exej._asview().setEnabled(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 153;BA.debugLine="final.asView.Visible = True";
mostCurrent._final._asview().setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 154;BA.debugLine="final.asView.Enabled = True";
mostCurrent._final._asview().setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 155;BA.debugLine="final.finalScore";
mostCurrent._final._finalscore();
 //BA.debugLineNum = 156;BA.debugLine="End Sub";
return "";
}
public static double  _finalscore() throws Exception{
 //BA.debugLineNum = 87;BA.debugLine="Public Sub finalScore As Double";
 //BA.debugLineNum = 88;BA.debugLine="Select scActive";
switch (_scactive) {
case 1: {
 //BA.debugLineNum = 90;BA.debugLine="score = avJ.finalAVscore";
_score = mostCurrent._avj._finalavscore();
 //BA.debugLineNum = 91;BA.debugLine="HelperFunctions.avResult = score";
...
_score = mostCurrent._tvj._finaltvscore();
 //BA.debugLineNum = 94;BA.debugLine="HelperFunctions.tvResult = score";
mostCurrent._helperfunctions._tvresult = BA.NumberToString(_score);
 break; }
case 3: {
 //BA.debugLineNum = 96;BA.debugLine="score = exeJ.finalEXEscore";
_score = mostCurrent._exej._finalexescore();
 //BA.debugLineNum = 97;BA.debugLine="HelperFunctions.exeResult = score";
mostCurrent._helperfunctions._exeresult = BA.NumberToString(_score);
 break; }
}
;
 //BA.debugLineNum = 99;BA.debugLine="Return score";
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 24;BA.debugLine="Private Login As LoginScreen";
mostCurrent._login = new agg.agg.loginscreen();
 //BA.debugLineNum = 25;BA.debugLine="Private typeJ As typeJudge";
mostCurrent._typej = new agg.agg.typejudge();
 //BA.debugLineNum = 26;BA.debugLine="Private avJ As AV_judge";
mostCurrent._avj = new agg.agg.av_judge();
 //BA.debugLineNum = 27;BA.debugLine="Private tvJ As TV_Judge";
mostCurrent._tvj = new agg.agg.tv_judge();
 //BA.debugLineNum = 28;BA.debugLine="Private exeJ As EXE_Judging";
mostCurrent._exej = new agg.agg.exe_judging();
 //BA.debugLineNum = 29;BA.debugLine="Private conn As Connector";
mostCurrent._conn = new agg.agg.connector();
 //BA.debugLineNum = 30;BA.debugLine="Private final As SendScore";
mostCurrent._final = new agg.agg.sendscore();
 //BA.debugLineNum = 31;BA.debugLine="Private SettingsScr As SettingsScreen";
mostCurrent._settingsscr = new agg.agg.settingsscreen();
...
public static String  _load_language() throws Exception{
 //BA.debugLineNum = 82;BA.debugLine="Private Sub Load_Language";
 //BA.debugLineNum = 83;BA.debugLine="translate.SetLanguage(SelectedLanguage)";
_translate._setlanguage(_selectedlanguage);
 //BA.debugLineNum = 84;BA.debugLine="End Sub";
return "";
}
public static String  _loginscreen_loginclick() throws Exception{
 //BA.debugLineNum = 102;BA.debugLine="Public Sub LoginScreen_LoginClick";
 //BA.debugLineNum = 103;BA.debugLine="Login.asView.Visible = False";
mostCurrent._login._asview().setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 104;BA.debugLine="Login.asView.Enabled = False";
mostCurrent._login._asview().setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 106;BA.debugLine="typeJ.asView.Visible = True";
mostCurrent._typej._asview().setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 107;BA.debugLine="typeJ.asView.Enabled = True";
...
_selectedlanguage = "BG";
 //BA.debugLineNum = 18;BA.debugLine="Type Report(ChartType As String,Title As String,X";
;
 //BA.debugLineNum = 19;BA.debugLine="Public BaseNotAccessible As Boolean";
_basenotaccessible = false;
 //BA.debugLineNum = 20;BA.debugLine="Public PrimeCurrency As String";
_primecurrency = "";
 //BA.debugLineNum = 21;BA.debugLine="End Sub";
return "";
}
public static String  _setsettingsscreen() throws Exception{
 //BA.debugLineNum = 158;BA.debugLine="Public Sub SetSettingsScreen";
 //BA.debugLineNum = 159;BA.debugLine="Login.asView.Visible = False";
mostCurrent._login._asview().setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 160;BA.debugLine="Login.asView.Enabled = False";
mostCurrent._login._asview().setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 162;BA.debugLine="SettingsScr.asView.Visible = True";
mostCurrent._settingsscr._asview().setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 163;BA.debugLine="SettingsScr.asView.Enabled = True";
mostCurrent._settingsscr._asview().setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 165;BA.debugLine="End Sub";
return "";
}
public static String  _tv_click() throws Exception{
 //BA.debugLineNum = 120;BA.debugLine="Public Sub TV_Click";
 //BA.debugLineNum = 121;BA.debugLine="typeJ.asView.Visible = False";
mostCurrent._typej._asview().setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 122;BA.debugLine="typeJ.asView.Enabled = False";
mostCurrent._typej._asview().setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 124;BA.debugLine="tvJ.asView.Visible = True";
mostCurrent._tvj._asview().setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 125;BA.debugLine="tvJ.asView.Enabled = True";
mostCurrent._tvj._asview().setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 126;BA.debugLine="scActive = 2";
_scactive = (int) (2);
 //BA.debugLineNum = 127;BA.debugLine="ProgramData.activeJ = scActive";
mostCurrent._programdata._activej = _scactive;
