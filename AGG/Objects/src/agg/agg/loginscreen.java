...
public anywheresoftware.b4a.objects.PanelWrapper  _asview() throws Exception{
 //BA.debugLineNum = 178;BA.debugLine="Public Sub asView As Panel";
 //BA.debugLineNum = 179;BA.debugLine="Return loginPanel";
...
int _padding = 0;
int _left = 0;
 //BA.debugLineNum = 38;BA.debugLine="Public Sub build_Screen";
 //BA.debugLineNum = 39;BA.debugLine="loginPanel_Configurations";
_loginpanel_configurations();
 //BA.debugLineNum = 40;BA.debugLine="start_up";
_start_up();
 //BA.debugLineNum = 42;BA.debugLine="Private edtWidth,edtHeight As Int";
_edtwidth = 0;
_edtheight = 0;
 //BA.debugLineNum = 43;BA.debugLine="Private btnWidth,btnHeight As Int";
_btnwidth = 0;
_btnheight = 0;
 //BA.debugLineNum = 44;BA.debugLine="Private Padding,left As Int";
_padding = 0;
_left = 0;
 //BA.debugLineNum = 47;BA.debugLine="Padding = UISizes.DefaultPadding";
_padding = _uisizes._defaultpadding;
 //BA.debugLineNum = 48;BA.debugLine="edtWidth = loginPanel.Width*0.7";
_edtwidth = (int) (_loginpanel.getWidth()*0.7);
 //BA.debugLineNum = 49;BA.debugLine="edtHeight = loginPanel.Height*0.08";
_edtheight = (int) (_loginpanel.getHeight()*0.08);
 //BA.debugLineNum = 50;BA.debugLine="btnHeight = loginPanel.Height*0.08";
_btnheight = (int) (_loginpanel.getHeight()*0.08);
 //BA.debugLineNum = 51;BA.debugLine="btnWidth = edtWidth/2 - Padding";
_btnwidth = (int) (_edtwidth/(double)2-_padding);
 //BA.debugLineNum = 52;BA.debugLine="left = (loginPanel.Width - edtWidth)/2";
_left = (int) ((_loginpanel.getWidth()-_edtwidth)/(double)2);
 //BA.debugLineNum = 54;BA.debugLine="loginPanel.AddView(user,left, loginPanel.Height*(";
_loginpanel.AddView((android.view.View)(_user.getObject()),_left,(int) (_loginpanel.getHeight()*(0.3)),_edtwidth,_edtheight);
 //BA.debugLineNum = 55;BA.debugLine="loginPanel.AddView(pass, left, user.Top+user.Heig";
_loginpanel.AddView((android.view.View)(_pass.getObject()),_left,(int) (_user.getTop()+_user.getHeight()*1.5+_padding),_edtwidth,_edtheight);
 //BA.debugLineNum = 57;BA.debugLine="loginPanel.AddView(checkloginPanel, left + Paddin";
_loginpanel.AddView((android.view.View)(_checkloginpanel.getObject()),(int) (_left+_padding),(int) (_pass.getTop()+_edtheight*1.5),_btnwidth,_btnheight);
 //BA.debugLineNum = 58;BA.debugLine="loginPanel.AddView(btnloginPanel, checkloginPanel";
_loginpanel.AddView((android.view.View)(_btnloginpanel.getObject()),(int) (_checkloginpanel.getLeft()+_checkloginpanel.getWidth()+_padding),_checkloginpanel.getTop(),_btnwidth,_btnheight);
 //BA.debugLineNum = 60;BA.debugLine="loginPanel.AddView(btnSettings, 0, 0, 9%x, 7%y)";
_loginpanel.AddView((android.view.View)(_btnsettings.getObject()),(int) (0),(int) (0),__c.PerXToCurrent((float) (9),ba),__c.PerYToCurrent((float) (7),ba));
 //BA.debugLineNum = 64;BA.debugLine="btnloginPanel.Enabled=True";
_btnloginpanel.setEnabled(__c.True);
 //BA.debugLineNum = 66;BA.debugLine="End Sub";
return "";
}
public String  _buttonloginpanel_click() throws Exception{
 //BA.debugLineNum = 129;BA.debugLine="Private Sub ButtonloginPanel_Click";
 //BA.debugLineNum = 131;BA.debugLine="btnloginPanel.Enabled=False";
_btnloginpanel.setEnabled(__c.False);
 //BA.debugLineNum = 134;BA.debugLine="usrString = user.Text.ToLowerCase";
_usrstring = _user.getText().toLowerCase();
 //BA.debugLineNum = 135;BA.debugLine="passString = pass.Text";
_passstring = _pass.getText();
 //BA.debugLineNum = 137;BA.debugLine="If check_User(usrString) And check_Pass(passStrin";
if (_check_user(_usrstring) && _check_pass(_passstring)) { 
 //BA.debugLineNum = 139;BA.debugLine="If checkloginPanel.Checked Then";
if (_checkloginpanel.getChecked()) { 
 //BA.debugLineNum = 140;BA.debugLine="write_Usrs";
_write_usrs();
 }else {
 //BA.debugLineNum = 142;BA.debugLine="File.Delete(File.DirDefaultExternal, \"users.co";
__c.File.Delete(__c.File.getDirDefaultExternal(),"users.config");
 };
 //BA.debugLineNum = 145;BA.debugLine="If usrString = ProgramData.strUser And ProgramD";
if ((_usrstring).equals(_programdata._struser) && (_programdata._strpass).equals(_passstring)) { 
 //BA.debugLineNum = 146;BA.debugLine="ProgramData.sameUser = True";
...
_programdata._sameuser = __c.False;
 ...
 //BA.debugLineNum = 151;BA.debugLine="ProgramData.sameUser = False";
_programdata._sameuser = __c.False;
 };
 //BA.debugLineNum = 154;BA.debugLine="ProgramData.strUser = usrString";
_programdata._struser = _usrstring;
 //BA.debugLineNum = 155;BA.debugLine="ProgramData.strPass = passString";
_programdata._strpass = _passstring;
 //BA.debugLineNum = 157;BA.debugLine="CallSub(Main, \"LoginScreen_LoginClick\")";
...
public boolean  _check_pass(String _text) throws Exception{
 //BA.debugLineNum = 174;BA.debugLine="Private Sub check_Pass(text As String) As Boolean";
...
anywheresoftware.b4a.keywords.Regex.MatcherWrapper _m = null;
 //BA.debugLineNum = 166;BA.debugLine="Private Sub check_User(text As String) As Boolean";
 //BA.debugLineNum = 167;BA.debugLine="Private m As Matcher";
_m = new anywheresoftware.b4a.keywords.Regex.MatcherWrapper();
 //BA.debugLineNum = 168;BA.debugLine="m = Regex.Matcher(\"[a-z0-9]+[_a-z0-9\\.-]*[a-z0-9]";
_m = __c.Regex.Matcher("[a-z0-9]+[_a-z0-9\\.-]*[a-z0-9]+@[a-z0-9-]+(\\.[a-z0-9-]+)*(\\.[a-z]{2,4})",_text);
 //BA.debugLineNum = 169;BA.debugLine="If m.Find Then Return True";
if (_m.Find()) { 
if (true) return __c.True;};
...
_pass = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 5;BA.debugLine="Public btnloginPanel, btnSettings As Button";
...
_btnloginpanel.Initialize(ba,"ButtonloginPanel");
 //BA.debugLineNum = 34;BA.debugLine="btnSettings.Initialize(\"SettingsScr\")";
_btnsettings.Initialize(ba,"SettingsScr");
 //BA.debugLineNum = 35;BA.debugLine="End Sub";
return "";
}
public String  _loginpanel_configurations() throws Exception{
 //BA.debugLineNum = 69;BA.debugLine="Private Sub loginPanel_Configurations";
 //BA.debugLineNum = 70;BA.debugLine="loginPanel.SetBackgroundImage(LoadBitmap(File.Dir";
_loginpanel.SetBackgroundImageNew((android.graphics.Bitmap)(__c.LoadBitmap(__c.File.getDirAssets(),"login_background.jpg").getObject()));
 //BA.debugLineNum = 73;BA.debugLine="HelperFunctions.Apply_ViewStyle(user,Colors.Black";
_helperfunctions._apply_viewstyle(ba,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_user.getObject())),__c.Colors.Black,__c.Colors.White,__c.Colors.White,__c.Colors.White,__c.Colors.White,__c.Colors.White,__c.Colors.White,(int) (60));
 //BA.debugLineNum = 74;BA.debugLine="user.Padding = Array As Int(15,0,0,0)";
_user.setPadding(new int[]{(int) (15),(int) (0),(int) (0),(int) (0)});
 //BA.debugLineNum = 75;BA.debugLine="user.SingleLine = True";
_user.setSingleLine(__c.True);
 //BA.debugLineNum = 77;BA.debugLine="user.Hint = Main.translate.GetString(\"hintMail\")";
_user.setHint(_main._translate._getstring("hintMail"));
 //BA.debugLineNum = 78;BA.debugLine="user.HintColor = Colors.Gray";
_user.setHintColor(__c.Colors.Gray);
 //BA.debugLineNum = 79;BA.debugLine="user.TextSize = 14";
_user.setTextSize((float) (14));
 //BA.debugLineNum = 81;BA.debugLine="HelperFunctions.Apply_ViewStyle(pass,Colors.Black";
_helperfunctions._apply_viewstyle(ba,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_pass.getObject())),__c.Colors.Black,__c.Colors.White,__c.Colors.White,__c.Colors.White,__c.Colors.White,__c.Colors.White,__c.Colors.White,(int) (60));
 //BA.debugLineNum = 82;BA.debugLine="pass.Padding = Array As Int(15,0,0,0)";
_pass.setPadding(new int[]{(int) (15),(int) (0),(int) (0),(int) (0)});
 //BA.debugLineNum = 83;BA.debugLine="pass.SingleLine = True";
_pass.setSingleLine(__c.True);
 //BA.debugLineNum = 84;BA.debugLine="pass.PasswordMode = True";
_pass.setPasswordMode(__c.True);
 //BA.debugLineNum = 85;BA.debugLine="pass.Hint = Main.translate.GetString(\"lblPassword";
_pass.setHint(_main._translate._getstring("lblPassword"));
 //BA.debugLineNum = 86;BA.debugLine="pass.HintColor = Colors.Gray";
_pass.setHintColor(__c.Colors.Gray);
 //BA.debugLineNum = 87;BA.debugLine="pass.TextSize = 14";
_pass.setTextSize((float) (14));
 //BA.debugLineNum = 89;BA.debugLine="checkloginPanel.TextColor=Colors.White";
_checkloginpanel.setTextColor(__c.Colors.White);
 //BA.debugLineNum = 90;BA.debugLine="checkloginPanel.TextSize = 14";
_checkloginpanel.setTextSize((float) (14));
 //BA.debugLineNum = 91;BA.debugLine="checkloginPanel.Gravity = Gravity.CENTER_VERTICAL";
_checkloginpanel.setGravity(__c.Gravity.CENTER_VERTICAL);
 //BA.debugLineNum = 92;BA.debugLine="checkloginPanel.Text = Main.translate.GetString(\"";
_checkloginpanel.setText(BA.ObjectToCharSequence(_main._translate._getstring("rememberMe")));
 //BA.debugLineNum = 95;BA.debugLine="HelperFunctions.Apply_ViewStyle(btnloginPanel,Col";
_helperfunctions._apply_viewstyle(ba,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_btnloginpanel.getObject())),__c.Colors.White,(int) (0xff4ac2ff),(int) (0xff149be0),(int) (0xff2cb7ff),(int) (0xff2cb7ff),(int) (0x66040509),(int) (0x66040509),(int) (60));
 //BA.debugLineNum = 96;BA.debugLine="btnloginPanel.TextSize = 14";
_btnloginpanel.setTextSize((float) (14));
 //BA.debugLineNum = 97;BA.debugLine="btnloginPanel.Gravity = Gravity.CENTER";
_btnloginpanel.setGravity(__c.Gravity.CENTER);
 //BA.debugLineNum = 98;BA.debugLine="btnloginPanel.Text = Main.translate.GetString(\"bt";
...
public String  _pass_focuschanged(boolean _hasfocus) throws Exception{
 //BA.debugLineNum = 103;BA.debugLine="Private Sub pass_FocusChanged (HasFocus As Boolean";
 //BA.debugLineNum = 104;BA.debugLine="If HasFocus Then";
if (_hasfocus) { 
 //BA.debugLineNum = 105;BA.debugLine="pass.Text=\"\"";
...
public String  _read_savedusrs() throws Exception{
 //BA.debugLineNum = 118;BA.debugLine="Private Sub Read_SavedUsrs";
 //BA.debugLineNum = 119;BA.debugLine="raf.Initialize(File.DirDefaultExternal, \"users.co";
_raf.Initialize(__c.File.getDirDefaultExternal(),"users.config",__c.False);
 //BA.debugLineNum = 120;BA.debugLine="usrString = raf.ReadEncryptedObject(ProgramData.r";
_usrstring = BA.ObjectToString(_raf.ReadEncryptedObject(BA.NumberToString(_programdata._rafencpass),_raf.CurrentPosition));
 //BA.debugLineNum = 121;BA.debugLine="passString = raf.ReadEncryptedObject(ProgramData.";
_passstring = BA.ObjectToString(_raf.ReadEncryptedObject(BA.NumberToString(_programdata._rafencpass),_raf.CurrentPosition));
 //BA.debugLineNum = 123;BA.debugLine="ProgramData.strUser = usrString";
_programdata._struser = _usrstring;
 //BA.debugLineNum = 124;BA.debugLine="ProgramData.strPass = passString";
_programdata._strpass = _passstring;
 //BA.debugLineNum = 125;BA.debugLine="raf.Close";
_raf.Close();
 //BA.debugLineNum = 126;BA.debugLine="End Sub";
return "";
}
public String  _settingsscr_click() throws Exception{
 //BA.debugLineNum = 161;BA.debugLine="Private Sub SettingsScr_Click";
 //BA.debugLineNum = 162;BA.debugLine="CallSub(Main, \"SetSettingsScreen\")";
__c.CallSubNew(ba,(Object)(_main.getObject()),"SetSettingsScreen");
...
public String  _write_usrs() throws Exception{
 //BA.debugLineNum = 110;BA.debugLine="Private Sub write_Usrs";
 //BA.debugLineNum = 111;BA.debugLine="raf.Initialize(File.DirDefaultExternal, \"users.co";
_raf.Initialize(__c.File.getDirDefaultExternal(),"users.config",__c.False);
 //BA.debugLineNum = 112;BA.debugLine="raf.WriteEncryptedObject(usrString, ProgramData.r";
_raf.WriteEncryptedObject((Object)(_usrstring),BA.NumberToString(_programdata._rafencpass),_raf.CurrentPosition);
 //BA.debugLineNum = 113;BA.debugLine="raf.WriteEncryptedObject(passString, ProgramData.";
_raf.WriteEncryptedObject((Object)(_passstring),BA.NumberToString(_programdata._rafencpass),_raf.CurrentPosition);
 //BA.debugLineNum = 114;BA.debugLine="raf.Close";
_raf.Close();
