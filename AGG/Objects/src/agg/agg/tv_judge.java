...
_downpanel.AddView((android.view.View)(_btnready.getObject()),(int) (_downpanel.getWidth()-__c.PerXToCurrent((float) (12),ba)),(int) (0),__c.PerXToCurrent((float) (10),ba),__c.DipToCurrent((int) (33)));
 //BA.debugLineNum = 79;BA.debugLine="page(0).AddView(label(0), 2%x, 5%y, 50%x, 7%y)";
...
_page[(int) (0)].AddView((android.view.View)(_chekpointbox1[(int) (0)].getObject()),(int) (_label[(int) (0)].getLeft()+_label[(int) (0)].getWidth()),_label[(int) (0)].getTop(),__c.PerXToCurrent((float) (35),ba),__c.PerYToCurrent((float) (7),ba));
...
_page[(int) (0)].AddView((android.view.View)(_chekpointbox2[(int) (0)].getObject()),(int) (_chekpointbox1[(int) (0)].getLeft()+_chekpointbox1[(int) (0)].getWidth()-__c.PerXToCurrent((float) (5),ba)),_chekpointbox1[(int) (0)].getTop(),__c.PerXToCurrent((float) (35),ba),__c.PerYToCurrent((float) (7),ba));
...
_page[(int) (0)].AddView((android.view.View)(_label[_i].getObject()),__c.PerXToCurrent((float) (2),ba),(int) (_label[(int) (_i-1)].getTop()+_label[(int) (_i-1)].getHeight()+__c.DipToCurrent((int) (3))),__c.PerXToCurrent((float) (50),ba),__c.PerYToCurrent((float) (7),ba));
...
_page[(int) (0)].AddView((android.view.View)(_chekpointbox1[_i].getObject()),(int) (_label[_i].getLeft()+_label[_i].getWidth()),_label[_i].getTop(),__c.PerXToCurrent((float) (35),ba),__c.PerYToCurrent((float) (7),ba));
...
_page[(int) (0)].AddView((android.view.View)(_chekpointbox2[_i].getObject()),(int) (_chekpointbox1[_i].getLeft()+_chekpointbox1[_i].getWidth()-__c.PerXToCurrent((float) (5),ba)),_chekpointbox1[_i].getTop(),__c.PerXToCurrent((float) (35),ba),__c.PerYToCurrent((float) (7),ba));
...
_chekpointbox2[_i].setTag((Object)(_i));
 ...
 //BA.debugLineNum = 110;BA.debugLine="page(1).AddView(label(6), 2%x, 5%y, 50%x, 7%y)";
_page[(int) (1)].AddView((android.view.View)(_label[(int) (6)].getObject()),__c.PerXToCurrent((float) (2),ba),__c.PerYToCurrent((float) (5),ba),__c.PerXToCurrent((float) (50),ba),__c.PerYToCurrent((float) (7),ba));
...
_page[(int) (1)].AddView((android.view.View)(_chekpointbox1[(int) (6)].getObject()),(int) (_label[(int) (6)].getLeft()+_label[(int) (6)].getWidth()),_label[(int) (6)].getTop(),__c.PerXToCurrent((float) (20),ba),__c.PerYToCurrent((float) (7),ba));
...
_page[(int) (1)].AddView((android.view.View)(_chekpointbox2[(int) (6)].getObject()),(int) (_chekpointbox1[(int) (6)].getLeft()+_chekpointbox1[(int) (6)].getWidth()),_chekpointbox1[(int) (6)].getTop(),__c.PerXToCurrent((float) (20),ba),__c.PerYToCurrent((float) (7),ba));
...
_page[(int) (1)].AddView((android.view.View)(_chekpointbox1[_i].getObject()),(int) (_label[_i].getLeft()+_label[_i].getWidth()),_label[_i].getTop(),__c.PerXToCurrent((float) (20),ba),__c.PerYToCurrent((float) (7),ba));
...
_page[(int) (1)].AddView((android.view.View)(_chekpointbox2[_i].getObject()),(int) (_chekpointbox1[_i].getLeft()+_chekpointbox1[_i].getWidth()),_chekpointbox1[_i].getTop(),__c.PerXToCurrent((float) (20),ba),__c.PerYToCurrent((float) (7),ba));
